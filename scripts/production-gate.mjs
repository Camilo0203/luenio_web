...
const steps = [
  ...
  ["Automation delivery queue", () => runNpmScript("test:automation-delivery")],
  ...
  ["Digest webhook delivery", () => runNpmScript("test:digest-delivery")],
  ["Lead validation service", () => runNpmScript("test:lead-validation")],
  ["Lead update service", () => runNpmScript("test:lead-update")],
  ["Lead capture service", () => runNpmScript("test:lead-capture")],
  ["Lead workspace service", () => runNpmScript("test:lead-workspace")],
  ["Lead import service", () => runNpmScript("test:lead-import")],
  ["api/leads.js wiring", () => runNpmScript("test:leads-handler-wiring")],
  ["Lead request router", () => runNpmScript("test:lead-request-router")],
